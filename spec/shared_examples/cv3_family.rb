...
RSpec.shared_context "cv3_family", dbclean: :after_each do
  ...
  let(:broker_agency_reference) do
    { hbx_id: "1233444", market_kind: 'both', name: 'broker agency', dba: nil, display_name: nil, fein: '089441964',
      corporate_npn: nil }
  end
  ...
  let(:family_entity) do
    AcaEntities::Families::Family.new(family_params.to_h)
  end
end
