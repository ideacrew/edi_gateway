  ...
  module Families
    module Notices
      ...
      class Corrected1095aNoticeRequestedSubscriber
        ...
        include ::EventSource::Subscriber[amqp: 'enroll.families.notices.corrected1095a_notice']

        subscribe(:on_requested) do |delivery_info, _metadata, response|
          routing_key = delivery_info[:routing_key]
          logger.info "Polypress: invoked Corrected1095aNoticeRequestedSubscriber with delivery_info: #{delivery_info} routing_key: #{routing_key}"
          ...
          logger.error(
            "Polypress: Corrected1095aNoticeRequestedSubscriber_error: nacked due to backtrace:
